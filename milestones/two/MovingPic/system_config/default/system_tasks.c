...
static void _LINE_SENSING_APP_Tasks(void);
...
void SYS_Tasks ( void )
{
    ...
    /* Create OS Thread for LINE_SENSING_APP Tasks. */
    xTaskCreate((TaskFunction_t) _LINE_SENSING_APP_Tasks,
                "LINE_SENSING_APP Tasks",
                512, NULL, 1, NULL);
...
/*******************************************************************************
  Function:
    void _LINE_SENSING_APP_Tasks ( void )

  Summary:
    Maintains state machine of LINE_SENSING_APP.
*/
