...
void APP_Tasks(void) {
    ...
    switch (appData.state) {
        ...
        case APP_STATE_SERVICE_TASKS:
        {
            ...
            drvI2CRDBUFHandle = DRV_I2C_TransmitThenReceive(appData.i2c_handle, deviceaddr, txBuffer, (sizeof (txBuffer)), rxBuffer, (sizeof (rxBuffer)), NULL);

            dbgOutputVal(rxBuffer[0]);
            DRV_I2C_Close(appData.i2c_handle);
            break;
        }
